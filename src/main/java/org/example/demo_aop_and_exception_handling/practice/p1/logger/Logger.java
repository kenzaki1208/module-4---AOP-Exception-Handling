package org.example.demo_aop_and_exception_handling.practice.p1.logger;
...
@Component
public class Logger {
    @AfterThrowing(pointcut = "execution(public * org.example.demo_aop_and_exception_handling.practice.p1.service.CustomerService.findAll(..))", throwing = "e")
